...
Once your account is granted access to the VSTS Docker extension, you can install the extension from [link](https://marketplace.visualstudio.com/items?itemName=ms-vscs-rm.docker)
